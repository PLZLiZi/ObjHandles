...
import plz.lizi.objhandles.api.superbyte.bytecode.ClassFile;
...
import plz.lizi.objhandles.api.superbyte.bytecode.ConstantAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.Descriptor;
import plz.lizi.objhandles.api.superbyte.bytecode.EnclosingMethodAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.FieldInfo;
import plz.lizi.objhandles.api.superbyte.bytecode.InnerClassesAttribute;
...
import plz.lizi.objhandles.api.superbyte.bytecode.annotation.Annotation;
import plz.lizi.objhandles.api.superbyte.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return plz.lizi.objhandles.api.superbyte.bytecode.annotation.AnnotationImpl.make(
    ...
    /**
     * @see plz.lizi.objhandles.api.superbyte.CtClass#prune()
     * @see plz.lizi.objhandles.api.superbyte.CtClass#stopPruning(boolean)
     */
    @Override
    public void prune()
    {
