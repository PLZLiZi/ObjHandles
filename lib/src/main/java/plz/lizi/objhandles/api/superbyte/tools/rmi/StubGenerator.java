...
package plz.lizi.objhandles.api.superbyte.tools.rmi;
...
import plz.lizi.objhandles.api.superbyte.CtNewConstructor;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.Translator#start(ClassPool)
     */
    @Override
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see plz.lizi.objhandles.api.superbyte.Translator#onLoad(ClassPool,String)
     */
    @Override
