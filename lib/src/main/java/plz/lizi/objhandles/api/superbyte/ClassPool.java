...
import plz.lizi.objhandles.api.superbyte.util.proxy.DefinePackageHelper;
 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.CtClass
 * @see plz.lizi.objhandles.api.superbyte.ClassPath
 */
...
public class ClassPool {
     ...
     * @see plz.lizi.objhandles.api.superbyte.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see plz.lizi.objhandles.api.superbyte.bytecode.ConstPool#getClassInfo(int)
     ...
     * @see plz.lizi.objhandles.api.superbyte.ByteArrayClassPath
     */
     ...
     * @see plz.lizi.objhandles.api.superbyte.ClassPath
     * @see plz.lizi.objhandles.api.superbyte.URLClassPath
     * @see plz.lizi.objhandles.api.superbyte.ByteArrayClassPath
     */
    ...
    {
        try {
            return plz.lizi.objhandles.api.superbyte.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return plz.lizi.objhandles.api.superbyte.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return plz.lizi.objhandles.api.superbyte.util.proxy.DefineClassHelper.toClass(ct.getName(),
