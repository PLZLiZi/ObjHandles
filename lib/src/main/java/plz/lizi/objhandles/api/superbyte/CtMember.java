...
public abstract class CtMember {
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute#toMethodSignature(String)
