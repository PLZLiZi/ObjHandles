 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.CtClass#instrument(ExprEditor)
 * @see plz.lizi.objhandles.api.superbyte.CtMethod#instrument(ExprEditor)
 * @see plz.lizi.objhandles.api.superbyte.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
 * @see plz.lizi.objhandles.api.superbyte.CodeConverter
 */
