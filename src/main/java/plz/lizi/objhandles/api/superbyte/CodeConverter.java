...
import plz.lizi.objhandles.api.superbyte.convert.TransformAccessArrayField;
import plz.lizi.objhandles.api.superbyte.convert.TransformAfter;
import plz.lizi.objhandles.api.superbyte.convert.TransformBefore;
import plz.lizi.objhandles.api.superbyte.convert.TransformCall;
import plz.lizi.objhandles.api.superbyte.convert.TransformCallToStatic;
import plz.lizi.objhandles.api.superbyte.convert.TransformFieldAccess;
import plz.lizi.objhandles.api.superbyte.convert.TransformNew;
import plz.lizi.objhandles.api.superbyte.convert.TransformNewClass;
import plz.lizi.objhandles.api.superbyte.convert.TransformReadField;
import plz.lizi.objhandles.api.superbyte.convert.TransformWriteField;
import plz.lizi.objhandles.api.superbyte.convert.Transformer;
 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.CtClass#instrument(CodeConverter)
 * @see plz.lizi.objhandles.api.superbyte.CtMethod#instrument(CodeConverter)
...
public class CodeConverter {
     ...
     * @see plz.lizi.objhandles.api.superbyte.CtMethod#setName(String)
     */
