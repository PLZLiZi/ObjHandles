...
import plz.lizi.objhandles.api.superbyte.tools.web.BadHttpRequest;
import plz.lizi.objhandles.api.superbyte.tools.web.Webserver;
 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.tools.rmi.ObjectImporter
 */
public class AppletServer extends Webserver {
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.tools.rmi.ObjectImporter#lookupObject(String)
     */
