...
package plz.lizi.objhandles.api.superbyte.bytecode.annotation;
 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.bytecode.AnnotationsAttribute#getAnnotations()
 * @see plz.lizi.objhandles.api.superbyte.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see plz.lizi.objhandles.api.superbyte.bytecode.AnnotationDefaultAttribute
     */
