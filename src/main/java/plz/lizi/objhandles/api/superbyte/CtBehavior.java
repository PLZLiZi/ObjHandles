...
package plz.lizi.objhandles.api.superbyte;

import plz.lizi.objhandles.api.superbyte.bytecode.AccessFlag;
import plz.lizi.objhandles.api.superbyte.bytecode.AnnotationsAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.AttributeInfo;
import plz.lizi.objhandles.api.superbyte.bytecode.BadBytecode;
import plz.lizi.objhandles.api.superbyte.bytecode.Bytecode;
import plz.lizi.objhandles.api.superbyte.bytecode.CodeAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.CodeIterator;
import plz.lizi.objhandles.api.superbyte.bytecode.ConstPool;
import plz.lizi.objhandles.api.superbyte.bytecode.Descriptor;
import plz.lizi.objhandles.api.superbyte.bytecode.ExceptionsAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.LineNumberAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.LocalVariableAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.LocalVariableTypeAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.MethodInfo;
import plz.lizi.objhandles.api.superbyte.bytecode.Opcode;
import plz.lizi.objhandles.api.superbyte.bytecode.ParameterAnnotationsAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute;
import plz.lizi.objhandles.api.superbyte.bytecode.StackMap;
import plz.lizi.objhandles.api.superbyte.bytecode.StackMapTable;
import plz.lizi.objhandles.api.superbyte.compiler.CompileError;
import plz.lizi.objhandles.api.superbyte.compiler.Javac;
import plz.lizi.objhandles.api.superbyte.expr.ExprEditor;
...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * a descriptor.
     *
     * @see plz.lizi.objhandles.api.superbyte.bytecode.Descriptor
     ...
     * It represents parameter types including type variables.
     * See {@link plz.lizi.objhandles.api.superbyte.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute.MethodSignature#encode()
     * @since 3.17
     */
    @Override
     ...
     * See {@link plz.lizi.objhandles.api.superbyte.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.runtime.Cflow
     */
     ...
     * @see plz.lizi.objhandles.api.superbyte.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
