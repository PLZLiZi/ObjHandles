 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see plz.lizi.objhandles.api.superbyte.CtClass#getClassFile()
 * @see plz.lizi.objhandles.api.superbyte.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
     ...
     * 
     * @see plz.lizi.objhandles.api.superbyte.bytecode.AccessFlag
     */
