...
public abstract class CtClass {
     ...
     */
    public plz.lizi.objhandles.api.superbyte.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see plz.lizi.objhandles.api.superbyte.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.CtConstructor
     */
     ...
     * are not included.
     *
     * @see plz.lizi.objhandles.api.superbyte.CtMethod
     */
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.CtField.Initializer#byExpr(String)
     * @see plz.lizi.objhandles.api.superbyte.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see plz.lizi.objhandles.api.superbyte.bytecode.AttributeInfo
     */
