 ...
 *
 * @see plz.lizi.objhandles.api.superbyte.ClassPool
 * @see plz.lizi.objhandles.api.superbyte.Translator
 */
public class Loader extends ClassLoader {
     ...
     *
     * @see plz.lizi.objhandles.api.superbyte.Loader#run(String[])
     */
    public static void main(String[] args) throws Throwable {
