...
import plz.lizi.objhandles.api.javassist.tools.web.BadHttpRequest;
import plz.lizi.objhandles.api.javassist.tools.web.Webserver;
 ...
 *
 * @see plz.lizi.objhandles.api.javassist.tools.rmi.ObjectImporter
 */
public class AppletServer extends Webserver {
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.tools.rmi.ObjectImporter#lookupObject(String)
     */
