 ...
 *
 * @see plz.lizi.objhandles.api.javassist.ClassPool
 * @see plz.lizi.objhandles.api.javassist.Translator
 */
public class Loader extends ClassLoader {
    ...
    private void init(ClassPool cp) {
        ...
        translator = null;
        domain = null;
        delegateLoadingOf("plz.lizi.objhandles.api.javassist.Loader");
    }
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.Loader#run(String[])
     */
    public static void main(String[] args) throws Throwable {
