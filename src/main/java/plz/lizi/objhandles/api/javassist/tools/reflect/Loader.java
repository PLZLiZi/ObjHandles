 ...
 *
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.Reflection
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.Compiler
 * @see plz.lizi.objhandles.api.javassist.Loader
 */
public class Loader extends plz.lizi.objhandles.api.javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("plz.lizi.objhandles.api.javassist.tools.reflect.Loader");
