 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see plz.lizi.objhandles.api.javassist.CtClass#getClassFile()
 * @see plz.lizi.objhandles.api.javassist.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
     ...
     * 
     * @see plz.lizi.objhandles.api.javassist.bytecode.AccessFlag
     */
