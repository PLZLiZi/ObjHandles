...
public abstract class CtMember {
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
