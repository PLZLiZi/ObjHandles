...
import plz.lizi.objhandles.api.javassist.util.proxy.DefinePackageHelper;
 ...
 *
 * @see plz.lizi.objhandles.api.javassist.CtClass
 * @see plz.lizi.objhandles.api.javassist.ClassPath
 */
...
public class ClassPool {
     ...
     * @see plz.lizi.objhandles.api.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see plz.lizi.objhandles.api.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see plz.lizi.objhandles.api.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see plz.lizi.objhandles.api.javassist.ByteArrayClassPath
     */
     ...
     * @see plz.lizi.objhandles.api.javassist.ClassPath
     * @see plz.lizi.objhandles.api.javassist.URLClassPath
     * @see plz.lizi.objhandles.api.javassist.ByteArrayClassPath
     */
    ...
    {
        try {
            return plz.lizi.objhandles.api.javassist.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return plz.lizi.objhandles.api.javassist.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return plz.lizi.objhandles.api.javassist.util.proxy.DefineClassHelper.toClass(ct.getName(),
