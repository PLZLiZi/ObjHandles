...
public abstract class CtClass {
     ...
     */
    public plz.lizi.objhandles.api.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.CtConstructor
     */
     ...
     * are not included.
     *
     * @see plz.lizi.objhandles.api.javassist.CtMethod
     */
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.CtField.Initializer#byExpr(String)
     * @see plz.lizi.objhandles.api.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see plz.lizi.objhandles.api.javassist.bytecode.AttributeInfo
     */
