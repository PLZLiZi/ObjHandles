...
package plz.lizi.objhandles.api.javassist.compiler;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import plz.lizi.objhandles.api.javassist.bytecode.Bytecode;
import plz.lizi.objhandles.api.javassist.bytecode.Opcode;
import plz.lizi.objhandles.api.javassist.compiler.ast.ASTList;
import plz.lizi.objhandles.api.javassist.compiler.ast.ASTree;
import plz.lizi.objhandles.api.javassist.compiler.ast.ArrayInit;
import plz.lizi.objhandles.api.javassist.compiler.ast.AssignExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.BinExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.CallExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.CastExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.CondExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.Declarator;
import plz.lizi.objhandles.api.javassist.compiler.ast.DoubleConst;
import plz.lizi.objhandles.api.javassist.compiler.ast.Expr;
import plz.lizi.objhandles.api.javassist.compiler.ast.FieldDecl;
import plz.lizi.objhandles.api.javassist.compiler.ast.InstanceOfExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.IntConst;
import plz.lizi.objhandles.api.javassist.compiler.ast.Keyword;
import plz.lizi.objhandles.api.javassist.compiler.ast.Member;
import plz.lizi.objhandles.api.javassist.compiler.ast.MethodDecl;
import plz.lizi.objhandles.api.javassist.compiler.ast.NewExpr;
import plz.lizi.objhandles.api.javassist.compiler.ast.Pair;
import plz.lizi.objhandles.api.javassist.compiler.ast.Stmnt;
import plz.lizi.objhandles.api.javassist.compiler.ast.StringL;
import plz.lizi.objhandles.api.javassist.compiler.ast.Symbol;
import plz.lizi.objhandles.api.javassist.compiler.ast.Variable;
import plz.lizi.objhandles.api.javassist.compiler.ast.Visitor;
...
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
    ...
    protected void atClassObject2(String cname) throws CompileError {
        ...
        */
        ...
        bytecode.growStack(1);
        bytecode.addInvokestatic("plz.lizi.objhandles.api.javassist.runtime.DotClass", "fail",
