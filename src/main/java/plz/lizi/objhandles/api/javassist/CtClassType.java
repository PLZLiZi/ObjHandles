...
import plz.lizi.objhandles.api.javassist.bytecode.ConstantAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.Descriptor;
import plz.lizi.objhandles.api.javassist.bytecode.EnclosingMethodAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.FieldInfo;
import plz.lizi.objhandles.api.javassist.bytecode.InnerClassesAttribute;
...
import plz.lizi.objhandles.api.javassist.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return plz.lizi.objhandles.api.javassist.bytecode.annotation.AnnotationImpl.make(
    ...
    /**
     * @see plz.lizi.objhandles.api.javassist.CtClass#prune()
     * @see plz.lizi.objhandles.api.javassist.CtClass#stopPruning(boolean)
     */
    @Override
    public void prune()
    {
