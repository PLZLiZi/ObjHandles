...
package plz.lizi.objhandles.api.javassist;

import plz.lizi.objhandles.api.javassist.bytecode.AccessFlag;
import plz.lizi.objhandles.api.javassist.bytecode.AnnotationsAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.AttributeInfo;
...
import plz.lizi.objhandles.api.javassist.bytecode.ExceptionsAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.LineNumberAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.LocalVariableAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.LocalVariableTypeAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.MethodInfo;
import plz.lizi.objhandles.api.javassist.bytecode.Opcode;
import plz.lizi.objhandles.api.javassist.bytecode.ParameterAnnotationsAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute;
import plz.lizi.objhandles.api.javassist.bytecode.StackMap;
import plz.lizi.objhandles.api.javassist.bytecode.StackMapTable;
import plz.lizi.objhandles.api.javassist.compiler.CompileError;
import plz.lizi.objhandles.api.javassist.compiler.Javac;
import plz.lizi.objhandles.api.javassist.expr.ExprEditor;
...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * a descriptor.
     *
     * @see plz.lizi.objhandles.api.javassist.bytecode.Descriptor
     ...
     * It represents parameter types including type variables.
     * See {@link plz.lizi.objhandles.api.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see plz.lizi.objhandles.api.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     * @since 3.17
     */
    @Override
     ...
     * See {@link plz.lizi.objhandles.api.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.runtime.Cflow
     */
    public void useCflow(String name) throws CannotCompileException
    {
        ...
        try {
            CtClass type = pool.get("plz.lizi.objhandles.api.javassist.runtime.Cflow");
     ...
     * @see plz.lizi.objhandles.api.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
