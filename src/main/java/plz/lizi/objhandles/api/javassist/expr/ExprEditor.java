 ...
 *
 * @see plz.lizi.objhandles.api.javassist.CtClass#instrument(ExprEditor)
 * @see plz.lizi.objhandles.api.javassist.CtMethod#instrument(ExprEditor)
 * @see plz.lizi.objhandles.api.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
