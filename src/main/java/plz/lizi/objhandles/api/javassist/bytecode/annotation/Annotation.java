...
package plz.lizi.objhandles.api.javassist.bytecode.annotation;
 ...
 *
 * @see plz.lizi.objhandles.api.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see plz.lizi.objhandles.api.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see plz.lizi.objhandles.api.javassist.bytecode.AnnotationDefaultAttribute
     */
