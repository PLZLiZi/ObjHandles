...
import plz.lizi.objhandles.api.javassist.bytecode.LineNumberAttributeBuilder;
import plz.lizi.objhandles.api.javassist.compiler.ast.*;
...
public class JvstCodeGenWitlLineNumber extends JvstCodeGen {
    ...
    @Override
    public void atStringL(plz.lizi.objhandles.api.javassist.compiler.ast.StringL s) throws CompileError {
        lineNumberAttributeBuilder.put(bytecode.currentPc(), s);
        super.atStringL(s);
    }
