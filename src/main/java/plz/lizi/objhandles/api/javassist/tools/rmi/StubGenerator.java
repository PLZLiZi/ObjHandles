...
package plz.lizi.objhandles.api.javassist.tools.rmi;
...
import plz.lizi.objhandles.api.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "plz.lizi.objhandles.api.javassist.tools.rmi.Sample";
     ...
     *
     * @see plz.lizi.objhandles.api.javassist.Translator#start(ClassPool)
     */
    @Override
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "plz.lizi.objhandles.api.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "plz.lizi.objhandles.api.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("plz.lizi.objhandles.api.javassist.tools.rmi.RemoteException") };
    }

    /**
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see plz.lizi.objhandles.api.javassist.Translator#onLoad(ClassPool,String)
     */
    @Override
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("plz.lizi.objhandles.api.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
