...
import plz.lizi.objhandles.api.javassist.bytecode.DuplicateMemberException;
 ...
 * {@link plz.lizi.objhandles.api.javassist.util.proxy.ProxyObjectOutputStream} and {@link plz.lizi.objhandles.api.javassist.util.proxy.ProxyObjectInputStream}
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "plz.lizi.objhandles.api.javassist.util.proxy.RuntimeSupport";
     ...
     * @see plz.lizi.objhandles.api.javassist.CtClass#setGenericSignature(String)
     * @since 3.26
     */
    ...
    private static final String packageForJavaBase = "plz.lizi.objhandles.api.javassist.util.proxy.";
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("plz.lizi.objhandles.api.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
                             "(Ljava/lang/Object;)Lplz/lizi/objhandles/api/javassist/util/proxy/SerializedProxy;");
        code.addOpcode(Opcode.ARETURN);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
