...
import plz.lizi.objhandles.api.javassist.CtNewMethod;
import plz.lizi.objhandles.api.javassist.Modifier;
import plz.lizi.objhandles.api.javassist.NotFoundException;
import plz.lizi.objhandles.api.javassist.Translator;
import plz.lizi.objhandles.api.javassist.CtMethod.ConstParameter;
 ...
 * </pre>
 *
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.ClassMetaobject
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.Metaobject
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.Loader
 * @see plz.lizi.objhandles.api.javassist.tools.reflect.Compiler
 */
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "plz.lizi.objhandles.api.javassist.tools.reflect.Metaobject";
    static final String classMetaobjectClassName
        = "plz.lizi.objhandles.api.javassist.tools.reflect.ClassMetaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "plz.lizi.objhandles.api.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("plz.lizi.objhandles.api.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("plz.lizi.objhandles.api.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("plz.lizi.objhandles.api.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("plz.lizi.objhandles.api.javassist.tools.reflect.ClassMetaobject"),
