...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            bytecode.addInvokestatic("plz/lizi/objhandles/api/javassist/runtime/Desc", "getParams",
    ...
    private void callGetType(String method) {
        bytecode.addInvokestatic("plz/lizi/objhandles/api/javassist/runtime/Desc", method,
                                "(Ljava/lang/String;)Ljava/lang/Class;");
        exprType = CLASS;
        arrayDim = 0;
        className = "java/lang/Class";
    ...
    protected void atCflow(ASTList cname, int lineNumber) throws CompileError {
        ...
        bytecode.addGetstatic((String)names[0], (String)names[1],
                              "Lplz/lizi/objhandles/api/javassist/runtime/Cflow;");
        bytecode.addInvokevirtual("plz.lizi.objhandles.api.javassist.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
