...
public abstract class CtClass {
     ...
     */
    public plz.lizi.objhandles.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see plz.lizi.objhandles.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see plz.lizi.objhandles.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     ...
     *
     * @see plz.lizi.objhandles.javassist.CtConstructor
     */
     ...
     * are not included.
     *
     * @see plz.lizi.objhandles.javassist.CtMethod
     */
     ...
     *
     * @see plz.lizi.objhandles.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see plz.lizi.objhandles.javassist.CtField.Initializer#byExpr(String)
     * @see plz.lizi.objhandles.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see plz.lizi.objhandles.javassist.bytecode.AttributeInfo
     */
