...
import plz.lizi.objhandles.javassist.bytecode.LineNumberAttributeBuilder;
import plz.lizi.objhandles.javassist.compiler.ast.*;
...
public class JvstCodeGenWitlLineNumber extends JvstCodeGen {
    ...
    @Override
    public void atStringL(plz.lizi.objhandles.javassist.compiler.ast.StringL s) throws CompileError {
        lineNumberAttributeBuilder.put(bytecode.currentPc(), s);
        super.atStringL(s);
    }
