...
import plz.lizi.objhandles.javassist.tools.web.BadHttpRequest;
import plz.lizi.objhandles.javassist.tools.web.Webserver;
 ...
 *
 * @see plz.lizi.objhandles.javassist.tools.rmi.ObjectImporter
 */
public class AppletServer extends Webserver {
     ...
     *
     * @see plz.lizi.objhandles.javassist.tools.rmi.ObjectImporter#lookupObject(String)
     */
