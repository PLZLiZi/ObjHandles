 ...
 *
 * @see plz.lizi.objhandles.javassist.tools.reflect.Reflection
 * @see plz.lizi.objhandles.javassist.tools.reflect.Compiler
 * @see plz.lizi.objhandles.javassist.Loader
 */
public class Loader extends plz.lizi.objhandles.javassist.Loader {
