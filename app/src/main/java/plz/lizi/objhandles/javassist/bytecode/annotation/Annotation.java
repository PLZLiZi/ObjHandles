...
package plz.lizi.objhandles.javassist.bytecode.annotation;
 ...
 *
 * @see plz.lizi.objhandles.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see plz.lizi.objhandles.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see plz.lizi.objhandles.javassist.bytecode.AnnotationDefaultAttribute
     */
