...
import plz.lizi.objhandles.javassist.bytecode.AccessFlag;
import plz.lizi.objhandles.javassist.bytecode.AnnotationsAttribute;
import plz.lizi.objhandles.javassist.bytecode.AttributeInfo;
...
import plz.lizi.objhandles.javassist.bytecode.ExceptionsAttribute;
import plz.lizi.objhandles.javassist.bytecode.LineNumberAttribute;
import plz.lizi.objhandles.javassist.bytecode.LocalVariableAttribute;
import plz.lizi.objhandles.javassist.bytecode.LocalVariableTypeAttribute;
import plz.lizi.objhandles.javassist.bytecode.MethodInfo;
import plz.lizi.objhandles.javassist.bytecode.Opcode;
import plz.lizi.objhandles.javassist.bytecode.ParameterAnnotationsAttribute;
import plz.lizi.objhandles.javassist.bytecode.SignatureAttribute;
import plz.lizi.objhandles.javassist.bytecode.StackMap;
import plz.lizi.objhandles.javassist.bytecode.StackMapTable;
import plz.lizi.objhandles.javassist.compiler.CompileError;
import plz.lizi.objhandles.javassist.compiler.Javac;
import plz.lizi.objhandles.javassist.expr.ExprEditor;
...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see plz.lizi.objhandles.javassist.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * It represents parameter types including type variables.
     * See {@link plz.lizi.objhandles.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see plz.lizi.objhandles.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     * @since 3.17
     */
    @Override
     ...
     * See {@link plz.lizi.objhandles.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see plz.lizi.objhandles.javassist.runtime.Cflow
     */
     ...
     * @see plz.lizi.objhandles.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
