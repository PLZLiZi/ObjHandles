...
import plz.lizi.objhandles.javassist.convert.TransformAccessArrayField;
import plz.lizi.objhandles.javassist.convert.TransformAfter;
import plz.lizi.objhandles.javassist.convert.TransformBefore;
import plz.lizi.objhandles.javassist.convert.TransformCall;
import plz.lizi.objhandles.javassist.convert.TransformCallToStatic;
import plz.lizi.objhandles.javassist.convert.TransformFieldAccess;
import plz.lizi.objhandles.javassist.convert.TransformNew;
import plz.lizi.objhandles.javassist.convert.TransformNewClass;
import plz.lizi.objhandles.javassist.convert.TransformReadField;
import plz.lizi.objhandles.javassist.convert.TransformWriteField;
import plz.lizi.objhandles.javassist.convert.Transformer;
 ...
 *
 * @see plz.lizi.objhandles.javassist.CtClass#instrument(CodeConverter)
 * @see plz.lizi.objhandles.javassist.CtMethod#instrument(CodeConverter)
...
public class CodeConverter {
     ...
     * @see plz.lizi.objhandles.javassist.CtMethod#setName(String)
     */
