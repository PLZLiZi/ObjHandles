...
import plz.lizi.objhandles.javassist.util.proxy.DefinePackageHelper;
 ...
 *
 * @see plz.lizi.objhandles.javassist.CtClass
 * @see plz.lizi.objhandles.javassist.ClassPath
 */
...
public class ClassPool {
     ...
     * @see plz.lizi.objhandles.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see plz.lizi.objhandles.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see plz.lizi.objhandles.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see plz.lizi.objhandles.javassist.ByteArrayClassPath
     */
     ...
     * @see plz.lizi.objhandles.javassist.ClassPath
     * @see plz.lizi.objhandles.javassist.URLClassPath
     * @see plz.lizi.objhandles.javassist.ByteArrayClassPath
     */
    ...
    {
        try {
            return plz.lizi.objhandles.javassist.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return plz.lizi.objhandles.javassist.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return plz.lizi.objhandles.javassist.util.proxy.DefineClassHelper.toClass(ct.getName(),
