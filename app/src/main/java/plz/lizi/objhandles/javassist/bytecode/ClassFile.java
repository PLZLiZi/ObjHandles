 ...
 * @see MethodInfo
 * @see ClassFileWriter
 * @see plz.lizi.objhandles.javassist.CtClass#getClassFile()
 * @see plz.lizi.objhandles.javassist.ClassPool#makeClass(ClassFile)
 */
public final class ClassFile {
     ...
     * 
     * @see plz.lizi.objhandles.javassist.bytecode.AccessFlag
     */
