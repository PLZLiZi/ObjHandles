...
package plz.lizi.objhandles.javassist.tools.rmi;
...
import plz.lizi.objhandles.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see plz.lizi.objhandles.javassist.Translator#start(ClassPool)
     */
    @Override
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see plz.lizi.objhandles.javassist.Translator#onLoad(ClassPool,String)
     */
    @Override
