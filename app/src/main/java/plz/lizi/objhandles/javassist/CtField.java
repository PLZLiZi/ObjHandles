...
import plz.lizi.objhandles.javassist.compiler.SymbolTable;
...
public class CtField extends CtMember {
     ...
     * @see plz.lizi.objhandles.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
    @Override
     ...
     *
     * @see CodeConverter
     * @see plz.lizi.objhandles.javassist.expr.ExprEditor
     */
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see plz.lizi.objhandles.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see plz.lizi.objhandles.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
