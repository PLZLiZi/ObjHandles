 ...
 *
 * @see plz.lizi.api.superbyte.CtClass#instrument(ExprEditor)
 * @see plz.lizi.api.superbyte.CtMethod#instrument(ExprEditor)
 * @see plz.lizi.api.superbyte.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
