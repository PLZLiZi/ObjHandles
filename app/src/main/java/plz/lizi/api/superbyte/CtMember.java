...
public abstract class CtMember {
     ...
     *
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see plz.lizi.api.superbyte.bytecode.SignatureAttribute#toMethodSignature(String)
