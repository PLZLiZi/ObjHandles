...
import plz.lizi.api.superbyte.bytecode.LineNumberAttributeBuilder;
import plz.lizi.api.superbyte.compiler.ast.*;
...
public class JvstCodeGenWitlLineNumber extends JvstCodeGen {
    ...
    @Override
    public void atStringL(plz.lizi.api.superbyte.compiler.ast.StringL s) throws CompileError {
        lineNumberAttributeBuilder.put(bytecode.currentPc(), s);
        super.atStringL(s);
    }
